...
$query="INSERT INTO `customer`(`fullname`, `telephone`, `email`, `message`) VALUES ('".$name."','".$phone."','".$email."','".$message."');";
...
<body background="img/90.jpg">
    ...
    <div class="container">
        ...
        <!-- Contact Form -->
        <!-- In order to http://localhost/x/contact.phpset the email address and subject line for the contact form go to the bin/contact_me.php file. -->
        <div class="row">
            <div class="col-md-8">
