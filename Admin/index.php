...
$query="INSERT INTO `product1`(  `img`) VALUES ('".'img/'.$img."');";
 mysqli_query($db, $query);
?>
<?php
...
$query="INSERT INTO `product2`(  `img`) VALUES ('".'img/'.$img."');";
 mysqli_query($db, $query);
?>
<?php
...
$query="INSERT INTO `product3`(  `img`) VALUES ('".'img/'.$img."');";
 mysqli_query($db, $query);
?>
<?php
...
$query="INSERT INTO `product4`(  `img`) VALUES ('".'img/'.$img."');";
 mysqli_query($db, $query);
?>
<?php
